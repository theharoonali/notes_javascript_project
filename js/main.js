...
var q1 = document.getElementById("question1-detail").innerHTML = "Question:1 Write about yourself";
var q2 = document.getElementById("question2-detail").innerHTML = "Question:2 What is your hobby?";
var q3 = document.getElementById("question3-detail").innerHTML = "Question:3 Write somrthing about your experience.";
var q4 = document.getElementById("question4-detail").innerHTML = "Question:4 Write about Gen-Z";
...
function mcqScreen() {
  ...
  document.getElementById("mcq").style.display = "block";
   ...
   function submitQuiz() {
     ...
     processQuestion("q2", "c", "Answer 2: The largest planet in our solar system is Jupiter.");
     processQuestion("q3", "b", "Answer 3: HTML stands for Hyper Text Markup Language.");
     processQuestion("q4", "a", "Answer 4: The chemical symbol for water is H2O.");
     processQuestion("q5", "b", "Answer 5: The Pacific Ocean is the largest ocean on Earth.");
     processQuestion("q6", "c", "Answer 6: JavaScript is a programming language commonly used for web development.");
     processQuestion("q7", "a", "Answer 7: The square root of 144 is 12.");
     processQuestion("q8", "c", "Answer 8: The United States of America has 50 states.");
     processQuestion("q9", "b", "Answer 9: CSS stands for Cascading Style Sheets.");
     processQuestion("q10", "a", "Answer 10: The formula E=mc^2 is associated with Albert Einstein.");
   ...
   function processQuestion(questionId, correctAnswer, explanation) {
     ...
     var selectedAnswer = document.querySelector('input[name="' + questionId + '"]:checked').value;
